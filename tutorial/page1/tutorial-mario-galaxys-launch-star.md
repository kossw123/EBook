...
![Character &#xBC0F; &#xC0AC;&#xC804;&#xC900;&#xBE44;](../../.gitbook/assets/image%20%2848%29.png)
...
![Window -&amp;gt; Package Manager -&amp;gt; Cinemachine Install](../../.gitbook/assets/image%20%2846%29.png)
...
![Insert StarLauncher.cs Empty Component](../../.gitbook/assets/image%20%2847%29.png)
...
![Dolly Track1 Inspector](../../.gitbook/assets/image%20%2828%29.png)

이제 LauncherObject에 쓸 별모양의 Trigger Object를 작성하는데 아래의 그림과 같은 모양을 가지고 있습니다.

![LauncherStar Objecct](../../.gitbook/assets/image%20%2825%29.png)
...
![LauncherStar Hierarchy](../../.gitbook/assets/image%20%2841%29.png)

{% tabs %}
{% tab title="LauncherStar Object" %}
![LauncherStar Object Component](../../.gitbook/assets/image%20%2835%29.png)

1. LauncherStar Object Component
   1. Animator 추가
      1. LaunchStart Animator로 설정
   2. Cinemachine Dolly Cart Script 추가
      1. Position Units = Normalized로 설정
   3. StarAnimation Script 추가
      1. 각각의 Particle 알맞게 추가
2. 
{% endtab %}
