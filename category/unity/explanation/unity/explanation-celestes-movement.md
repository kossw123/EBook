...
Vector2.Lerp() 함수는 _rb.velocity와 (new Vector2(dir.x  speed, rb.velocity.y))_ 사이를 연결해서 0부터 1사이의 값을 가진 wallJumpLerp  \* Time.deltaTime의 비율에 따라 값을 반환합니다.&#x20;
...
{% embed url="http://dotween.demigiant.com/documentation.php#genericTo" %}
DoTween Document
{% endembed %}
...
{% embed url="https://docs.unity3d.com/ScriptReference/Physics2D.OverlapCircle.html" %}
OverlapCircle() Document
{% endembed %}
...
{% embed url="https://docs.unity3d.com/kr/530/Manual/AnimationOverview.html" %}
Animation System
{% endembed %}
...
![Celeste's Movement Animator](<../../../../.gitbook/assets/image (8).png>)
...
![Animation Window](<../../../../.gitbook/assets/image (109).png>)
...
![Celeste's Movement Animator](<../../../../.gitbook/assets/image (23).png>)

Animator를 가지고 원하는 Animation Clip들을 parameter의 변화에 맞춰 조정합니다.

![Test Animator](<../../../../.gitbook/assets/image (63).png>)
...
![Idle -> Walk Transition 조건](<../../../../.gitbook/assets/image (21).png>)
...
{% embed url="https://www.youtube.com/watch?v=CE9VOZivb3I&t=943s" %}
Scene Transition
{% endembed %}
...
![Scene A에 배치해야할 Hierarchy, Component 종류](<../../../../.gitbook/assets/image (97).png>)
...
![ Crossfade\_Start : Property마다 0초부터 60초까지의 변화하는 모습](../../../../.gitbook/assets/crossfade\_start.gif)

![Crossfade\_End : Property마다 0초부터 60초까지의 변화하는 모습](../../../../.gitbook/assets/crossfade\_end.gif)
...
![LevelLoader Animator](<../../../../.gitbook/assets/image (54).png>)
