...
{% embed url="https://drive.google.com/file/d/1H4mX9yAwuhBzSbh2bRxM7jIuuUQsDoWu/view" %}
유니티로 시네마틱 제작하기 : 타임라인 & 시네머신 Sample File
{% endembed %}
...
![Red : Key값을 통한 값의 이동 / Green : Activation Track 설정 / Blue : Animation Track 설정](<../../../../.gitbook/assets/image (244).png>)
