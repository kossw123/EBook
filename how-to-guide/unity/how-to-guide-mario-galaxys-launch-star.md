...
public class MovementInput: MonoBehaviour {
  ...
  /// <summary>
	/// Script Component로 넣은 Object의 Rotation을 받아 Quaternion으로 x, y, z, w축으로 나누어 Slerp함수로 회전을 시킨다.
	/// *** Quaternion을 쓰는 이유는 2가지 이상의 축이 움직였을 때 예측값이 다른 현상, 즉 먼저 회전한 축이 다른 축에 영향을 끼치는데 이것을 짐벌락이라고 한다.
	/// *** 이것을 해결하기 위해 한가지의 축을 더 넣었으며 Quaternion에서는 회전값을 Euler와 달리 한번에 회전시켜 이 문제를 해결
	/// https://docs.unity3d.com/kr/current/Manual/QuaternionAndEulerRotationsInUnity.html
	/// https://m.blog.naver.com/PostView.nhn?blogId=dj3630&logNo=221447943453&proxyReferer=https%3A%2F%2Fwww.google.com%2F
	/// </summary>
	/// <param name="pos">Script Component를 넣은 Object의 transform</param>
