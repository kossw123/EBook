...
void Update()
{
    ...
    // GetAxis를 기반으로 새로운 방향 생성
    Vector2 dir = new Vector2(x, y);
    // 생성된 방향을 기반으로 한 Walk 함수 실행
    Walk(dir);
    // Animator  Component를 받아와 SethorizontalMoverment Animation을 재생할지 결
    anim.SetHorizontalMovement(x, y, rb.velocity.y);

    // 벽에 충돌중 이고,Fire3버튼을 누르고 canMove가 true
